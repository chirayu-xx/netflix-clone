...
function Banner({netflixOriginals} : Props) {
  ...
  return (
    <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[76vh] justify-end lg:pb-12">
        <div className="absolute top-0 left-0 h-[95vh] w-full -z-10 overflow-x-hidden">
